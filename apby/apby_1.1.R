...
output = function(data, date_start, date_stop) {
        ...
        data2k12.pm10_24.aot500 = na.omit(select(data2k12,date,pm10_24, aot500))
        ...
        print(g)
        ggsave(g, file="reg2012pm10_24.pdf")
        ggsave(g, file="reg2012pm10_24.png")
        ...
        print(g)
        ggsave(g, file="reg2012pm10_1016.pdf")
        ggsave(g, file="reg2012pm10_1016.png")
        
        cor10_0817 = round(cor(data2k12$pm10_0817, data2k12$aot500, use="complete.obs"),2)
        g <- ggplot(data2k12, aes(aot500, pm10_0817) ) 
        g <- g + geom_point() + geom_smooth(method="lm") + ggtitle(paste(periode,"(cor=",cor10_0817,")" ))
        
        print(g)
        ggsave(g, file="reg2012pm10_0817.pdf")
        ggsave(g, file="reg2012pm10_0817.png")
